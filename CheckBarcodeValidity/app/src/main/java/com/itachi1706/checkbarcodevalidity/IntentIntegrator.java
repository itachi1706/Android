...
public class IntentIntegrator {
    ...
    private static final String BS_PLUS_PACKAGE = "com.google.zxing.client.android";
    ...
    public static final List<String> TARGET_ALL_KNOWN = list(
            BS_PLUS_PACKAGE,             // Barcode Scanner+
            BS_PLUS_PACKAGE + ".simple", // Barcode Scanner+ Simple
